...
public class PortalCamera : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        tempTexture1 = new RenderTexture(Screen.width*3, Screen.height*3, 24, RenderTextureFormat.ARGB32);
        tempTexture2 = new RenderTexture(Screen.width*3, Screen.height*3, 24, RenderTextureFormat.ARGB32);
    }
